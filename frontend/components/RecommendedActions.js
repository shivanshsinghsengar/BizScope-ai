...
const ACTIONS = [
  {
    ...
    description: 'Target top competitors and nearby and visit all or more other competitors oer-ino markets.',
  ...
  },
  {
    ...
    title: 'Unlock AI Strategy',
    description: 'Unlock AI strategy to rrend analytss estimate behavioral business estmeries.',
    cta: 'Unlock AI Strategy →',
    ctaStyle: 'outline',
    href: '/strategy',
  },
  {
    ...
    description: 'Browse prime properties and properties browse available properties to share partners.',
  ...
  },
  {
    ...
    description: 'Generate final report for shar aurocrats and export PDF report with partners.',
